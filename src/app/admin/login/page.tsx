...
export default function AdminLoginPage() {
  const { loading, user, statusPending, signIn, doSignInEmail, doSignUpEmail } =
    useAuth();
  ...
  // Redirect to dashboard once the user is fully approved.
  useEffect(() => {
    if (!loading && user && !statusPending) {
      router.replace("/admin/dashboard");
    }
  }, [loading, user, statusPending, router]);
