...
export const MARKET_BENCHMARKS_2026: HotelBenchmark[] = [
  // ── Paros (11) ──
  {
    ...
    location: "Paros",
    locationDetail: "Naousa",
    stars: 4,
    rooms: 12,
    directUrl: "https://www.booking.com/hotel/gr/lilly-residence.html",
    capturedAt: "2026-05-22",
    notes:
      "Hotel site SSL-broken; via booking.com. 3-night min stay in HIGH season (€2,349/3 = €783/night). MED 2-night €1,566 = €783/night (Sep 8-10 direct match).",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 783,
        doubleRoomEur: 783,
        premiumSuiteEur: null,
        luxurySuiteEur: null,
        villaEur: null,
      },
      {
  ...
  },
  {
    ...
    stars: 4,
    rooms: 30,
    directUrl: "https://www.booking.com/hotel/gr/senia.html",
    capturedAt: "2026-05-22",
    notes:
      "Hotel site broken; via booking.com. HIGH 3-night min: €3,813/3 = €1,271/night. MED 2-night sidebar €1,581 = €790/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 1271,
  ...
  {
    name: "Andronis Minois",
    location: "Paros",
    stars: 5,
    rooms: 44,
    directUrl: "https://www.booking.com/hotel/gr/andronis-minois-paros.html",
    capturedAt: "2026-05-22",
    notes:
      "Original 2025 CSV row labeled 'Andronis Paros' actually pointed to 'Andronis Minois Paros'. Captured via booking.com sidebar: HIGH €1,798 / 2 = €899/night, MED €1,505 / 2 = €753/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 899,
  ...
  },
  {
    ...
    stars: 5,
    rooms: 33,
    directUrl: "https://www.booking.com/hotel/gr/parilio.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com sidebar. HIGH €2,010 / 2 = €1,005/night. MED €2,118 / 2 = €1,059/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 1005,
  ...
  },
  {
    ...
    stars: 5,
    rooms: 45,
    directUrl: "https://www.booking.com/hotel/gr/cove-paros.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com sidebar. MED €2,132 / 2 = €1,066/night. HIGH not surfaced in sidebars this pass.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
  ...
  {
    name: "Cosme, a Luxury Collection Resort",
    location: "Paros",
    stars: 5,
    rooms: 40,
    directUrl: "https://cosmeparos.com",
    capturedAt: null,
    notes:
      "Not found in this session's booking.com searches. 2025 CSV had €2,250 HIGH / €2,250 MED for basic, suggesting it's one of the higher-priced Paros properties. Needs targeted re-capture.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
  ...
  },
  {
    ...
    stars: 5,
    rooms: 40,
    directUrl: "https://www.astirofparos.com",
    capturedAt: null,
    notes:
      "Not found in this session's booking.com searches. 2025 CSV had €640 HIGH / €420 MED basic. Needs targeted re-capture.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
  ...
  },
  {
    ...
    stars: 5,
    rooms: 41,
    directUrl: "https://www.booking.com/hotel/gr/parocks.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com sidebar. HIGH €2,144 / 2 = €1,072/night. MED €1,734 / 2 = €867/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 1072,
  ...
  {
    name: "Yria Island Boutique Hotel & Spa",
    location: "Paros",
    locationDetail: "Parasporos",
    stars: 5,
    rooms: 60,
    directUrl: "https://www.booking.com/hotel/gr/yria.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com. HIGH 2-night €1,445.70 = €723/night (Aug 2-4 alt). MED 2-night €1,162.56 = €581/night (Sep 6-8 alt).",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 723,
  ...
  {
    name: "Avant Mar Paros",
    location: "Paros",
    stars: 5,
    rooms: 38,
    directUrl: "https://www.booking.com/hotel/gr/avantmar.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com sidebar. HIGH €3,885 / 2 = €1,943/night. MED €2,370 / 2 = €1,185/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 1943,
  ...
  {
    name: "Bohemian Luxury Boutique Hotel",
    location: "Paros",
    stars: 4,
    rooms: 17,
    directUrl: "https://www.booking.com/hotel/gr/bohemian-luxury-boutique.html",
    capturedAt: "2026-05-22",
    notes:
      "Captured via booking.com sidebar. HIGH €1,122 / 2 = €561/night. MED €1,268 / 2 = €634/night.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: 561,
  ...
  // ── Antiparos (3) ──
  {
    ...
    location: "Antiparos",
    locationDetail: "Livadia Bay",
    stars: 5,
    rooms: 17,
    directUrl: "https://reservations.theroosterantiparos.com",
    capturedAt: "2026-05-22",
    notes:
      "HIGH season SOLD OUT in early August — demand signal. MED captured via reserve-online engine. ALL CATEGORIES ARE DETACHED VILLAS (FarmHouse, Bush & Hill, Wilderness Valley, etc.) — no hotel rooms. Reported in villaEur; basicRoomEur intentionally null. Entry villa €1,715/night MED.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
  ...
  },
  {
    ...
    stars: 5,
    rooms: null,
    directUrl: "https://www.kameosuites.com",
    capturedAt: null,
    notes:
      "Hotel site broken (no error page returned). Not found in booking.com sidebars this session. Needs targeted re-capture (try kameoantiparos.com direct or alternative search).",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
  ...
  {
    name: "The Beach House Antiparos",
    location: "Antiparos",
    stars: 5,
    rooms: 9,
    directUrl: "https://thebeachhouseantiparos.com",
    capturedAt: null,
    notes:
      "Not searched this session — only 9 rooms, small comparable. 2025 CSV had €562 HIGH / €551 MED basic. Needs targeted re-capture.",
    pricing: [
      {
        season: "HIGH",
        basicRoomEur: null,
